...
class AssistantLLMService:
    ...
    def __init__(self):
        ...
        self.llm = ChatHuggingFace(llm=model, verbose=True)

        self.retrieve = RetrieverTool()
    ...
    def generate_answer(self, state: MessagesState, user_query):
        """Generate answer."""
        ...
        prompt = [SystemMessage(system_message_content)] + conversation_messages + user_query
